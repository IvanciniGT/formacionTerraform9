locals {
    ...
    contenido_fichero_clave_publica_openssh = local.existe_fichero_clave_privada_pem     ? file(local.fichero_clave_privada_pem)     : null
    contenido_fichero_clave_publica_pem     = local.existe_fichero_clave_privada_openssh ? file(local.fichero_clave_privada_openssh) : null
    contenido_fichero_clave_privada_openssh = local.existe_fichero_clave_publica_pem     ? file(local.fichero_clave_publica_pem)     : null
    contenido_fichero_clave_privada_pem     = local.existe_fichero_clave_publica_openssh ? file(local.fichero_clave_publica_openssh) : null
}
